...
class DurchgangModel extends Durchgang {
  const DurchgangModel({
    ...
    super.typ,
    super.status,
    super.pflanzenAnzahlStart,
    super.pflanzenAnzahlVegi,
    super.pflanzenAnzahlBluete,
  ...
  factory DurchgangModel.fromJson(Map<String, dynamic> json) {
    ...
    return DurchgangModel(
      ...
      pflanzenAnzahlStart: (json['pflanzen_anzahl_start'] as num?)?.toInt(),
      pflanzenAnzahlVegi: (json['pflanzen_anzahl_vegi'] as num?)?.toInt(),
      pflanzenAnzahlBluete: (json['pflanzen_anzahl_bluete'] as num?)?.toInt(),
  ...
  factory DurchgangModel.fromEntity(Durchgang d) {
    return DurchgangModel(
      ...
      typ: d.typ,
      status: d.status,
      pflanzenAnzahlStart: d.pflanzenAnzahlStart,
      pflanzenAnzahlVegi: d.pflanzenAnzahlVegi,
      pflanzenAnzahlBluete: d.pflanzenAnzahlBluete,
  ...
  Map<String, dynamic> toJson() {
    return {
      ...
      'typ': typ,
      'status': status,
      'pflanzen_anzahl_start': pflanzenAnzahlStart,
      'pflanzen_anzahl_vegi': pflanzenAnzahlVegi,
      'pflanzen_anzahl_bluete': pflanzenAnzahlBluete,
